...
class QuizBuilder:
    """Builds quiz questions from the Baden-Baden text."""
    
    QUIZ_CONFIGS = {
        "place": {
            "replace": ("Baden-Baden", "( ___ )"),
            "options": {"A": "Heidelberg", "B": "Dresden", "C": "Baden-Baden", "D": "Munich"},
            "correct": "C"
        },
        "year": {
            "replace": ("2007", "( ___ )"),
        ...
        "storm": {
            "replace": ("Kyrill", "( ___ )"),
            "options": {"A": "Xaver", "B": "Kyrill", "C": "Lothar", "D": "Sabine"},
            "correct": "B"
        },
        "ast_meaning": {
            "replace": ("'ast' means 'twig'", "'ast' means '( ___ )'"),
            "options": {"A": "twig", "B": "light", "C": "stone", "D": "river"},
            "correct": "A"
        },
        "bad_meaning": {
            "replace": ("'Bad' is the German word for 'bath'", "'Bad' is the German word for '( ___ )'"),
            "options": {"A": "mountain", "B": "sea", "C": "river", "D": "bath"},
            "correct": "D"
        }
    }
    ...
    @classmethod
    def build(cls, target: str) -> Tuple[str, Dict[str, str], str]:
        """Build a quiz question for the given target."""
        target = target.lower()
